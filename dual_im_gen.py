...
imlist = pd.read_csv("data/benthoz2015/imagelist.csv")
...
def dual_im_gen(data_dir, batch_size):
    ...
    while 1:
        ...
        for i in range(int(n_images/batch_size)):
            ...
            yield [np.array(batch_crops), np.array(batch_source)], np.array(labels)
...
def get_source(web_loc):
    benthoz_dir = "/Users/user1/Documents/thesis/data/benthoz2015"
